...
MunitResult cursor_position_should_initialise_to_zero_test(const MunitParameter params[], void* user_data_or_fixture)
{
    // Given
    unsigned char framebuffer[80 * 25 * 2];
    Cursor cursor = create_cursor_mock();
...
MunitTest cursor_tests[] = 
{
    ...
    { "/cursor_position_should_initialise_to_zero_test", cursor_position_should_initialise_to_zero_test, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
